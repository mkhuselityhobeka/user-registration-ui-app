...
public class StudentApplication implements Serializable{
	...
	public String toString() {
		return "StudentApplication [id=" + id + ", first_name=" + first_name + ", last_name=" + last_name + ", pob="
				...
				+ reason_for_leaving + ", past_results=" + past_results + ", address=" + address + ", getId()="
				...
				+ getReason_for_leaving() + ", getPast_results()=" + getPast_results() + ", getAddress()="
